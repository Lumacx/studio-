...
const getMyPaymentsRef = (dc) => {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetMyPayments');
}
getMyPaymentsRef.operationName = 'GetMyPayments';
exports.getMyPaymentsRef = getMyPaymentsRef;

exports.getMyPayments = function getMyPayments(dc) {
...
const getMyLegalDisclaimersRef = (dc) => {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetMyLegalDisclaimers');
}
getMyLegalDisclaimersRef.operationName = 'GetMyLegalDisclaimers';
exports.getMyLegalDisclaimersRef = getMyLegalDisclaimersRef;

exports.getMyLegalDisclaimers = function getMyLegalDisclaimers(dc) {
