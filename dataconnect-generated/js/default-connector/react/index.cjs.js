...
exports.useGetMyPayments = function useGetMyPayments(dcOrOptions, options) {
  const { dc: dcInstance, options: inputOpts } = validateReactArgs(connectorConfig, dcOrOptions, options);
...
exports.useGetMyLegalDisclaimers = function useGetMyLegalDisclaimers(dcOrOptions, options) {
  const { dc: dcInstance, options: inputOpts } = validateReactArgs(connectorConfig, dcOrOptions, options);
