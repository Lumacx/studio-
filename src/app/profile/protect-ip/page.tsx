...
export default function ProtectIPPage() {
  ...
  // const [currentStep, setCurrentStep] = useState(0); // Dependency disabled for testing
  ...
  const onVerificationSuccess = () => {
    ...
    // setCurrentStep(2); // Dependency disabled for testing
  ...
  /* // Dependency disabled for testing
  ...
  */
  ...
  const handleSaveIP = async () => {
    ...
    if (chain?.id !== 1514) {
        ...
        toast({ title: "Please switch to Story Mainnet.", variant: "destructive" });
    ...
    <div className="min-h-screen bg-[#0b1220] text-[#E0C9A0] font-['Georgia'] p-6 flex flex-col items-center">
      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-12 px-4 md:px-20">
          ...
          <div className={`hidden md:block h-0.5 w-16 bg-[#BFA071]`}></div>
          ...
          {!ipSaved ? (
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="max-w-md mx-auto">
                ...
                <StoryProtocolWidget onSave={handleSaveIP} onConnect={() => setShowEvmDialog(true)} isConnected={true} />
